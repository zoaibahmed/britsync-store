...
export default function AboutWebflowClient() {
  ...
  return (
    <div style={{ backgroundColor: "#070709", color: "#FAF9F6", overflow: "hidden" }}>
      
      {/* ════════════════════════════════════════════════════════════
          1. KINETIC HERO SECTION (WEBFLOW EDITORIAL LUXURY)
          ════════════════════════════════════════════════════════════ */}
      <section
        style={{
      ...
      >
        ...
        <div style={{ maxWidth: "1150px", margin: "0 auto", textAlign: "center", position: "relative", zIndex: 10 }}>
          ...
          >
            Britsync is a sovereign curation registry and digital trust platform. We bridge secluded mountain ateliers and historic craft guilds directly with international patrons — protecting ancient lineages through cryptographic passports, legal Geographic Indication (GI) protection, and direct escrow payouts.
          </motion.p>
      ...
      {/* ════════════════════════════════════════════════════════════
          2. THE FOUR COLUMNS OF TRUST ARCHITECTURE (WEBFLOW ACCORDION / GRID)
          ════════════════════════════════════════════════════════════ */}
      <section
        style={{
          padding: "8.5rem 2rem",
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    backgroundColor: isSelected ? "#0F0F15" : "#070709",
                    border: isSelected ? "1px solid var(--accent)" : "1px solid rgba(212,175,55,0.2)",
                ...
                >
                  <div>
                    ...
                    <p style={{ fontSize: "0.9rem", lineHeight: 1.8, color: "rgba(250,249,246,0.72)", margin: 0, fontWeight: 300 }}>
                      {pillar.description}
                    </p>
                  </div>
                  ...
                  {isSelected && (
                    <motion.div
                      ...
                      style={{ marginTop: "1.4rem", paddingTop: "1rem", borderTop: "1px solid rgba(212,175,55,0.2)", fontSize: "0.82rem", color: "var(--accent)" }}
                    >
                      ✦ {pillar.detail}
                    </motion.div>
                  )}
      ...
      {/* ════════════════════════════════════════════════════════════
          3. MASTER ARTISAN CHRONICLES (WEBFLOW INTERACTIVE STAGE)
          ════════════════════════════════════════════════════════════ */}
      <section
        style={{
          padding: "9.5rem 2rem",
        ...
        <div style={{ maxWidth: "1350px", margin: "0 auto" }}>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div style={{ position: "relative", height: "500px", border: "1px solid rgba(212,175,55,0.22)" }}>
                <img
      ...
      {/* ════════════════════════════════════════════════════════════
          ...
          ════════════════════════════════════════════════════════════ */}
      <section style={{ padding: "8.5rem 2rem", backgroundColor: "#070709", borderBottom: "1px solid rgba(212,175,55,0.2)" }}>
        <div style={{ maxWidth: "1250px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: "4.5rem", alignItems: "center" }}>
            <div>
              ...
              <div style={{ display: "flex", gap: "1.8rem", borderTop: "1px solid rgba(212,175,55,0.2)", paddingTop: "1.8rem" }}>
                <div>
      ...
      {/* ════════════════════════════════════════════════════════════
          6. TRUST FAQ ACCORDION (WEBFLOW STYLE)
          ════════════════════════════════════════════════════════════ */}
      <section
        style={{
          padding: "8.5rem 2rem",
            ...
            {TRUST_FAQS.map((faq, idx) => {
              ...
              return (
                <div
                  ...
                  style={{
                    backgroundColor: "#070709",
                    border: isOpen ? "1px solid var(--accent)" : "1px solid rgba(212,175,55,0.2)",
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <h3 style={{ fontFamily: "var(--font-playfair), Georgia, serif", fontSize: "1.2rem", fontWeight: 400, color: "#FAF9F6", margin: 0 }}>
                      {faq.q}
                    </h3>
                  ...
                  {isOpen && (
                    <motion.p
                      ...
                      style={{ marginTop: "1rem", fontSize: "0.92rem", lineHeight: 1.8, color: "rgba(250,249,246,0.72)", margin: "1rem 0 0", fontWeight: 300 }}
                    >
                      {faq.a}
                    </motion.p>
                  )}
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem", fontFamily: "monospace", fontSize: "0.82rem" }}>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <span style={{ color: "#FAF9F6" }}>{selectedAuditArtisan.status}</span>
                  </div>
                  <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <span style={{ opacity: 0.6 }}>ALTITUDE:</span>
                    <span style={{ color: "rgba(250,249,246,0.8)" }}>{selectedAuditArtisan.altitude}</span>
                  </div>
                </div>
              </div>
